...
(function(_,O) {
    typeof exports=="object"&&typeof module<"u"?module.exports=O():
    typeof define=="function"&&define.amd?define(O): (_=typeof globalThis<"u"?globalThis:_||self,_.ImageTool=O())
})
(this,function(){"use strict";const _="",
    O='' +
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M11 19V19C9.13623 19 8.20435 19 7.46927 18.6955C6.48915 18.2895 5.71046 17.5108 5.30448 ' +
        '16.5307C5 15.7956 5 14.8638 5 13V12C5 9.19108 5 7.78661 5.67412 6.77772C5.96596 6.34096 6.34096 ' +
        '5.96596 6.77772 5.67412C7.78661 5 9.19108 5 12 5H13.5C14.8956 5 15.5933 5 16.1611 5.17224C17.4395 ' +
        '5.56004 18.44 6.56046 18.8278 7.83886C19 8.40666 19 9.10444 19 10.5V10.5"/>' +
    ...
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M5 13L13 5"/></svg>',
    D='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M18.9919 9.5H19.0015"/>' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M14.5 5H14.5096"/>' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-width="2" ' +
        'd="M14.625 5H15C17.2091 5 19 6.79086 19 9V9.375"/>' +
    ...
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M9.3725 19H9.38207"/>' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M5 14.55H5.00957"/>' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-width="2" ' +
        'd="M16 13V16M16 19V16M19 16H16M16 16H13"/></svg>',
    R='' +
        '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">' +
    '<rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/>' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M5.13968 15.32L8.69058 11.5661C9.02934 11.2036 9.48873 11 9.96774 11C10.4467 11 10.9061 ' +
        '11.2036 11.2449 11.5661L15.3871 16M13.5806 14.0664L15.0132 12.533C15.3519 12.1705 15.8113 ' +
        '11.9668 16.2903 11.9668C16.7693 11.9668 17.2287 12.1705 17.5675 12.533L18.841 13.9634"/>' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M13.7778 9.33331H13.7867"/></svg>',
    x='' +
        '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">' +
    '<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" ' +
        'd="M17 9L20 12L17 15"/>' +
    ...
    class T {
        ...
        render(a){
            return!a.file||Object.keys(a.file).length===0?this.toggleStatus(T.status.EMPTY):
                this.toggleStatus(T.status.UPLOADING),
                this.nodes.wrapper
        }
         createFileButton() {
            const a=M("div",[this.CSS.button]);
            return a.innerHTML=this.config.buttonContent||`${R} ${this.api.i18n.t("Select an Image")}`,
                a.addEventListener("click",()=>{this.onSelectFile()}),
                a
        }
        // createImageContainer() {
        //     const a= M("div",[this.CSS.imageContainer]);
        //     // return a.innerHTML=this.config.buttonContent||`${O} ${this.api.i18n.t("Click to crop")}`,
        //     //     a.addEventListener("click",()=>{this.onSelectFile()}),
        //     //     a
        // }

        showPreloader(a){
            this.nodes.imagePreloader.style.backgroundImage=`url(${a})`,
            this.toggleStatus(T.status.UPLOADING)}hidePreloader(){
            this.nodes.imagePreloader.style.backgroundImage="",
            this.toggleStatus(T.status.EMPTY)
        }
        fillImage(a){
            const i=/\.mp4$/.test(a)?"VIDEO":"IMG",c={src:a};
            let r="load";i==="VIDEO"&&(c.autoplay=!0,c.loop=!0,c.muted=!0,c.playsinline=!0,r="loadeddata"),
                this.nodes.imageEl=M(i,this.CSS.imageEl,c),
                this.nodes.imageEl.addEventListener(r,()=>{this.toggleStatus(T.status.FILLED),
        ...
        toggleStatus(a){
            for(const i in T.status)
                Object.prototype.hasOwnProperty.call(T.status,i)&&this.nodes.wrapper.classList.toggle
                (`${this.CSS.wrapper}--${T.status[i]}`,a===T.status[i])
        }
        applyTune(a,i){
    ...
    var H={exports:{}};
    (function(E,a){
        (function(i,c){E.exports=c()})
        (window,function(){return function(i){
        var c={};
        function r(n){
        ...
        return r.m=i,r.c=c,
            r.d=function(n,o,d){r.o(n,o)||Object.defineProperty(n,o,{enumerable:!0,get:d})},
            r.r=function(n){
            ...
            var d=Object.create(null);
                if(r.r(d),Object.defineProperty(
                    d,
                    "default",
                    ...
                    for(var b in n)
                        r.d(d,b,(function(u){return n[u]}).bind(null,b));
                return d},r.n=function(n){
            var o=n&&n.__esModule?function(){return n.default}:
                function(){
                return n
            };
            return r.d(o,"a",o),o
            ...
            r.p="",r(r.s=3)}([function(i,c){
                var r;r=function(){return this}();
                try{
        ...
        function(i,c,r){
                (function(n){
                    var o=r(2),d=setTimeout;function b(){}function u(e){
                        if(!(this instanceof u))throw new TypeError("Promises must be constructed via new");
                        if(typeof e!="function")throw new TypeError("not a function");
                        this._state=0,this._handled=!1,this._value=void 0,this._deferreds=[],t(e,this)
                    }
                    function p(e,l){
                        for(;e._state===3;)e=e._value;e._state!==0?(e._handled=!0,u._immediateFn(
                            function(){
                            var s=e._state===1?l.onFulfilled:l.onRejected;
                            if(s!==null){var g;try{g=s(e._value)}catch(m){
                                return void y(l.promise,m)}f(l.promise,g)
                            }
                            else
                    ...
                    function w(e)
                    {
                        e._state===2&&e._deferreds.length===0&&u._immediateFn(
                            function(){
                                e._handled||u._unhandledRejectionFn(e._value)
                            });
                        for(var l=0,s=e._deferreds.length;l<s;l++)
                            p(e,e._deferreds[l]);e._deferreds=null}
                    function v(e,l,s){
                    ...
                    function t(e,l){
                        var s=!1;
                        try{
                            e(function(g){s||(s=!0,f(l,g))},
                                function(g){s||(s=!0,y(l,g))})}
                        catch(g){
                            if(s)
                                return;
                            s=!0,
                    ...
                    u.prototype.catch=function(e)
                    {
                                ...
                                try{
                                    if(C&&(typeof C=="object"||typeof C=="function")){
                                        ...
                                        if(typeof j=="function")
                                            return void j.call(C,function(I){h(S,I)},s)
                                    }
                                    g[S]=C,--m==0&&l(g)
                                }
                                catch(I){s(I)}}
                        ...
                        return e&&typeof e=="object"&&e.constructor===u?e:new u(function(l){l(e)})
                        },
                        u.reject=function(e){
                        return new u(function(l,s){s(e)})
                        },
                        u.race=function(e){
                        return new u(function(l,s){
                            for(var g=0,m=e.length;g<m;g++)
                                e[g].then(l,s)})},
                        u._immediateFn=typeof n=="function"&&function(e){n(e)}||function(e){
                        d(e,0)},
            ...
            function(i,c,r){
                c.a=function(n){
                    ...
                    return this.then(function(d){return o.resolve(n()).then(function(){return d})},
                        function(d){return o.resolve(n()).then(function(){return o.reject(d)})})
                }
            },
            function(i,c,r){
                function n(t){
                    return(n=typeof
                        Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e)
                    {
                        return typeof e
                    }:function(e){
                        return e&&typeof
                            Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e
                    })
                    (t)
                }
                r(4);
                var o,d,b,u,p,f,y,w=r(8),v=(d=function(t){
                    return new Promise(function(e,l){
                        t=u(t),
                        (t=p(t)).beforeSend&&t.beforeSend();
                        var s=window.XMLHttpRequest?new window.XMLHttpRequest:new window.ActiveXObject("Microsoft.XMLHTTP");
                        s.open(t.method,t.url),
                            s.setRequestHeader("X-Requested-With","XMLHttpRequest"),
                            Object.keys(t.headers).forEach(function(m){
                                var h=t.headers[m];
                            ...
                            s.upload.addEventListener("progress",function(m){
                                ...
                                if(s.readyState===4){
                                    ...
                                    var h=w.parseHeaders(s.getAllResponseHeaders()),
                                        k={body:m,code:s.status,headers:h};
                                    y(s.status)?e(k):l(k)
                                }
                                },
                                s.send(t.data)})
                    ...
                    p=function(t){
                    switch(t.method) {
                        case"GET":var e=f(t.data,o.URLENCODED);
                        delete t.data,
                            ...
                            case"PUT":
                                case"DELETE":
                                    case"UPDATE":
                                        ...
                                        (t);
                        (w.isFormData(t.data)||w.isFormElement(t.data))&&(l=o.FORM),
                            t.data=f(t.data,l),
                        l!==v.contentType.FORM&&(t.headers["content-type"]=l)
                    }
                    return t
                    },
                    f=function(){
                    ...
                    },
                    {
                        ...
                        transport:function(t){
                            return t=u(t),
                                w.selectFiles(t).then(function(e){
            ...
            function(i,c,r){
                (function(n){
                    var o=n!==void 0&&n||typeof
                        self<"u"&&self||window,d=Function.prototype.apply;function b(u,p){
                            this._id=u,
                                this._clearFn=p}c.setTimeout=function(){
                            return new b(d.call(setTimeout,o,arguments),clearTimeout)},
                        c.setInterval=function(){
                            return new b(d.call(setInterval,o,arguments),clearInterval)},
                        c.clearTimeout=c.clearInterval=function(u){u&&u.close()},
                        ...
                        c._unrefActive=c.active=function(u){
                            ...
                            p>=0&&(u._idleTimeoutId=setTimeout(function(){
                                u._onTimeout&&u._onTimeout()},p))
                        },
                        r(6),
                        c.setImmediate=typeof
                            self<"u"&&self.setImmediate||n!==void 0&&n.setImmediate||
                            this&&this.setImmediate,c.clearImmediate=typeof
                        self<"u"&&self.clearImmediate||
                        n!==void 0&&n.clearImmediate||
                        this&&this.clearImmediate}).call(this,r(0))},
            function(i,c,r){
                (function(n,o){
                    (function(d,b){
                        if(!d.setImmediate){
                            var u,p,f,y,w,v=1,t={},e=!1,
                                l=d.document,
                                s=Object.getPrototypeOf&&Object.getPrototypeOf(d);
                            s=s&&s.setTimeout?s:d,
                                {}.toString.call(d.process)==="[object process]"?u=function(h){
                                o.nextTick(function(){m(h)
                                })
                            }: function(){
                                if(d.postMessage&&!d.importScripts){
                                    var h=!0,k=d.onmessage;
                                    return d.onmessage=function(){h=!1},
                                        d.postMessage("","*"),
                                        d.onmessage=k,h}}()?(y="setImmediate$"+Math.random()+"$",
                                    w=function(h){
                                            h.source===d&&
                                            typeof h.data=="string"&&
                                            h.data.indexOf(y)===0&&m(+h.data.slice(y.length))},
                                    d.addEventListener?d.addEventListener("message",w,!1):
                                        d.attachEvent("onmessage",w),
                                    u=function(h){
                                            d.postMessage(y+h,"*")
                                        }) :
                                    d.MessageChannel?((f=new MessageChannel).port1.onmessage=
                                        function(h){
                                        m(h.data)},
                                        u=function(h){
                                        f.port2.postMessage(h)
                                    }):
                                        l&&"onreadystatechange"in l.createElement("script")?(p=
                                            l.documentElement,
                                            u=function(h){
                                ...
                                for(var k=new Array(arguments.length-1),
                                        S=0;
                                    S<k.length;S++)k[S]=arguments[S+1];
                                var C={callback:h,args:k};
                                return t[v]=C,u(v),v++},
                                s.clearImmediate=g}
                        function g(h){
                            delete t[h]}function m(h){
                            if(e)
                                setTimeout(m,0,h);
                            else{
                                var k=t[h];
                                if(k){
                                    e=!0;
                                    try{
                                        (function(S){var C=S.callback, j=S.args;
                                            switch(j.length){
                                                case 0:C();
                                                break;
                                                case 1:C(j[0]);
            ...
            function(i,c){
                var r,n,o=i.exports={};
                    ...
                    function l(){}o.nextTick=function(s){
                            ...
                            return b=d,p=[{
                                ...
                                key:"selectFiles",
                                    ...
                                    return new Promise(function(y,w){
                                        ...
                                        v.type="file",f.multiple&&
                                        v.setAttribute("multiple","multiple"),
                                        f.accept&&v.setAttribute("accept",f.accept),
                ...
                var r=function(o){
                    ...
                    return d=d||null,b=b||"&",u=u||null,o?function(p){
                        for(var f=new Array,y=0;y<p.length;y++)
                            p[y]&&f.push(p[y]);
                        return f}(Object.keys(o).map(function(p){
                            var f,y,w=p;
                                        if(u&&(w=u+"["+w+"]"),
                                        typeof o[p]=="object"&&o[p]!==null)f=n(o[p],null,b,w);
                                        else{
                                            d&&(y=w,w=!isNaN(parseFloat(y))&&isFinite(y)?d+Number(w):w);
                                        var v=o[p];
                                        v=(v=(v=(v=v===!0?"1":v)===!1?"0":v)===0?"0":v)||"",
                                            f=r(w)+"="+r(v)}return f})).join(b).replace(/[!'()*]/g,""):""};i.exports=n
            }])
        })
    })
    (H);
    ...
    class A{
        ...
        uploadSelectedFile({onPreview:a}){
            ...
            this.config.uploader&&typeof this.config.uploader.uploadByFile=="function"?c=F.selectFiles({
                ...
                c=F.transport({url:this.config.endpoints.byFile,
                    data:this.config.additionalRequestData,
                    accept:this.config.types,
                    headers:this.config.additionalRequestHeaders,
                    beforeSend:r=>{i(r[0])},
                    fieldName:this.config.field}).then(r=>r.body),
                c.then(r=>{this.onUpload(r)}).catch(r=>{
                    this.onError(r)
                })
        }
        uploadByUrl(a){
            ...
            typeof this.config.uploader.uploadByUrl=="function"?(i=this.config.uploader.uploadByUrl(a),
            L(i)||console.warn("Custom uploader method uploadByUrl should return a Promise")):
                i=F.post({url:this.config.endpoints.byUrl,
                    data:Object.assign({url:a},
                        this.config.additionalRequestData),
                    type: F.contentType.JSON,
                    headers:this.config.additionalRequestHeaders
                }).then(c=>c.body),
                i.then(c=>{this.onUpload(c)}).catch(c=>{this.onError(c)})
        }
        uploadByFile(a,{onPreview:i}){
            const c=new FileReader;
            c.readAsDataURL(a),
                c.onload=n=>{i(n.target.result)};
            let r;
            if(this.config.uploader&&typeof this.config.uploader.uploadByFile=="function")
                r=this.config.uploader.uploadByFile(a),
                L(r)||console.warn("Custom uploader method uploadByFile should return a Promise");
            else{
                const n=new FormData;
                n.append(this.config.field,a),
                this.config.additionalRequestData&&
                Object.keys(this.config.additionalRequestData).length&&
                Object.entries(this.config.additionalRequestData).forEach(([o,d])=>{
                    n.append(o,d)
                }),
                    r=F.post({
                        url:this.config.endpoints.byFile,data:n,
                        type:F.contentType.JSON,
                        headers:this.config.additionalRequestHeaders
                    }).then(o=>o.body)
            }
            r.then(n=>{this.onUpload(n)}).catch(n=>{this.onError(n)})
        }
    }
    /**
 ...
 */class P {
    ...
    save() {
        ...
        return this._data.caption = a.innerHTML,
        this.data
    }
    ...
    uploadingFailed(a) {
        console.log("Image Tool: uploading failed because of", a),
    ...
    setTune(a, i) {
        this._data[a] = i,
        this.ui.applyTune(a, i), a === "stretched" &&
